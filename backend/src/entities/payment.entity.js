...
let Payment = (() => {
    ...
    var Payment = _classThis = class {
        constructor() {
            ...
            this.contract = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _contract_initializers, void 0));
            ...
            this.documents = (__runInitializers(this, _contractId_extraInitializers), __runInitializers(this, _documents_initializers, void 0));
    ...
    (() => {
        ...
        _amount_decorators = [(0, typeorm_1.Column)({ type: 'decimal', precision: 15, scale: 2 })];
        _date_decorators = [(0, typeorm_1.Column)({ type: 'date' })];
        _description_decorators = [(0, typeorm_1.Column)({ type: 'text', nullable: true })];
        _contract_decorators = [(0, typeorm_1.ManyToOne)(() => contract_entity_1.Contract, { onDelete: 'CASCADE' }), (0, typeorm_1.JoinColumn)({ name: 'contractId' })];
        _contractId_decorators = [(0, typeorm_1.Column)({ type: 'uuid' })];
        _documents_decorators = [(0, typeorm_1.OneToMany)(() => document_entity_1.Document, (document) => document.payment, { cascade: true })];
