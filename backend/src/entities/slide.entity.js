...
let Slide = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('slides')];
    ...
    var Slide = _classThis = class {
        constructor() {
            ...
            this.multimediaUrl = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _multimediaUrl_initializers, void 0));
            this.linkUrl = (__runInitializers(this, _multimediaUrl_extraInitializers), __runInitializers(this, _linkUrl_initializers, void 0));
            this.duration = (__runInitializers(this, _linkUrl_extraInitializers), __runInitializers(this, _duration_initializers, void 0));
            this.startDate = (__runInitializers(this, _duration_extraInitializers), __runInitializers(this, _startDate_initializers, void 0));
            this.endDate = (__runInitializers(this, _startDate_extraInitializers), __runInitializers(this, _endDate_initializers, void 0));
            this.order = (__runInitializers(this, _endDate_extraInitializers), __runInitializers(this, _order_initializers, void 0));
    ...
    __setFunctionName(_classThis, "Slide");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _title_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 255 })];
        _description_decorators = [(0, typeorm_1.Column)({ type: 'text', nullable: true })];
        _multimediaUrl_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 500, nullable: true })];
        _linkUrl_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 500, nullable: true })];
        _duration_decorators = [(0, typeorm_1.Column)({ type: 'int', default: 3 })];
        _startDate_decorators = [(0, typeorm_1.Column)({ type: 'datetime', nullable: true })];
        _endDate_decorators = [(0, typeorm_1.Column)({ type: 'datetime', nullable: true })];
        ...
        Slide = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Slide = _classThis;
})();
exports.Slide = Slide;
