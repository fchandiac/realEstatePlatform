...
let DocumentType = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('document_types')];
    ...
    var DocumentType = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "DocumentType");
    (() => {
        ...
        DocumentType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DocumentType = _classThis;
})();
