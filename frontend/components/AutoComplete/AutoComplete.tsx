...
const AutoComplete = <T = Option,>({
  ...
  return (
    <div className="relative w-full pt-0.5" data-test-id={props["data-test-id"] || "auto-complete-root"}>
      ...
      />
      {required && !shrink && (
        <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-sm font-light pointer-events-none text-foreground">
