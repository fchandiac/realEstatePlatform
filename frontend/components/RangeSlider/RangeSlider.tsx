...
const RangeSlider: React.FC<RangeSliderProps> = ({ min = 0, max = 100, value, onChange }) => {
    ...
    return (
        <div className="w-full" data-test-id="range-slider-root">
            ...
            <div className="relative w-full h-8 select-none" ref={trackRef} data-test-id="range-slider-track">
                {/* Track */}
                <div className="absolute w-full h-2 top-1/2 -translate-y-1/2 rounded-lg appearance-none" style={{ background: 'var(--color-neutral)' }} data-test-id="range-slider-bg" />
                {/* Filled Range */}
                <div
