...
- **Diseño y Layout:**
  ...
  - **Fila Inferior (Información y Navegación):**
    ...
    - **Columna 2 - Menú:** Lista de navegación plana (sin subcategorías) con los enlaces directos a las secciones principales (Inicio, Propiedades, Publica tu propiedad, Servicios, Nuestro equipo, Testimonios, Blog). El texto de los enlaces está **centrado horizontalmente** bajo el título "Menu".
    ...
    - **Columna 5 - Redes Sociales:** Esta columna es más ancha (`col-span-2` en pantallas medianas) para destacar la presencia social. Se eliminó el título de la sección y los iconos están **alineados a la izquierda**. Los iconos de las redes (Instagram, Facebook, LinkedIn, YouTube) se aumentaron al doble de su tamaño original (`text-4xl`) para mayor impacto visual.
